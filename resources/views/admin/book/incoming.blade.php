    ...
    <div class="modal-dialog">
        ...
        <div class="modal-body" style="text-align: center">
            <form action="{{ route('admin.book.update') }}" method="POST">
                ...
                <input type="number" id="approve" name="approve" value="5" hidden class="form-control">
                <h4>Are you certain that the job has been completed? </h4>
                        ...
                        <table class="table table-bordered" id="data-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($item->status == 3)
                                        <span class="badge rounded-pill bg-success">On the way</span>
                                        @endif
                                    </td>

                                    <td style="text-align: center">
                                        {{-- <button class="btn btn-primary" onclick="showSwal('passing-parameter-execute-cancel')">Click here!</button> --}}
                                        <button type="button" class="btn btn-success" data-url="{{ route('admin.show.approve', $item->id) }}" id="approve-button">Done</button>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
