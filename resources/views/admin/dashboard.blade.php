...
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>Sir Naps Catering</title>

    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="{{asset('../assets/images/favicon.png')}}">

    <link rel="stylesheet" href="{{asset('../assets/vendor/bootstrap5.0.2/css/bootstrap.css')}}">
...
***********************************-->
    ...
    <script src="{{ asset('../assets/vendor/bootstrap5.0.2/js/bootstrap.bundle.js') }}"></script>
