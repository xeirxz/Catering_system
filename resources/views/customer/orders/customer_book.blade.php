                        ...
                        <div class="menu-product d-flex">
                            ...
                            <div class="content-detail-wrap">
                                ...
                                <div class="mt-4 d-flex justify-content-between align-items-center">
                                    <div>
                                        <h5 class="mb-0"><span class="fs-14 me-2">start From</span>${{ $price->price }}</h5>
                                        <span class="text-danger">Customization available</span>
                                    </div>
                                    <div>
                                        <a href="{{ route('customer.packageCustomer', ['id' => $price->id]) }}" class="btn btn-danger" id="show-package">View</a>
                                    </div>
                                </div>
                            </div>
                        </div>
